...
// enable click images
  ...
  //  public void updateTracker(string TrackerID)
    ...
    //go back to main when save button is pressed
    public void goToMain(){
        Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
    }

    //make sure the user enters a tracker name and id before saved
    public boolean validateTrackerName(){
        String trackerNameInput = trackerNameEdit.getText().toString().trim();
        if(trackerNameInput.isEmpty()){
            trackerNameEdit.setError("Tracker name cannot be empty!!");
    ...
    //hide action bar if no name entered
    public void hideActionBar()
    {
        if(!validateTrackerName()){
